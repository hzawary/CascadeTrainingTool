...
namespace AForge.Math.Geometry
{
    ...
    public sealed class Line
    {
        ...
        private Line( float radius, float theta, bool unused )
        {
            ...
            //theta *= (float) ( AForge.Math.Tools.DegreeFactor );
            theta *= 0.01745329251994329576923690768489f;
        ...
        public float GetAngleBetweenLines( Line secondLine )
        {
            ...
            //angle *= (float) ( AForge.Math.Tools.RadianFactor );
            angle *= 57.295779513082320876798154814105f;
