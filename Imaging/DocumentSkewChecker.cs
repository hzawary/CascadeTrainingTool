    ...
    public class DocumentSkewChecker
    {
        ...
        private void InitHoughMap( )
        {
            if ( needToInitialize )
            {
                ...
                thetaStep = (2 * maxSkewToDetect * 0.01745329251994329576923690768489) / houghHeight;
                ...
                for ( int i = 0; i < houghHeight; i++ )
                {
                    sinMap[i] = Math.Sin((minTheta * 0.01745329251994329576923690768489) + (i * thetaStep));
                    cosMap[i] = Math.Cos((minTheta * 0.01745329251994329576923690768489) + (i * thetaStep));
                }
            }
        }
    }
